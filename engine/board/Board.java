...
public class Board {
    ...
    public Iterable<Piece> getAllActivePieces(){
        ...
        allActivePieces.addAll(this.whitePieces);
        allActivePieces.addAll(this.blackPieces);
        return ImmutableList.copyOf(allActivePieces);
        //return Iterables.unmodifiableIterable(Iterables.concat(this.blackPlayer.getLegalMoves(), this.whitePlayer.getLegalMoves()));
    }
